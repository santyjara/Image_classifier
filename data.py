...
def prepare_dataset(data_path,new_dir):
    ...
    for i in range(len(path)):
        ...
        for j in boxes[i]:
            ...
            metadic['img path'].append(os.path.join(new_dir,new_name))
            ...
            #metaData.append({'Path':os.path.join('sss',new_name), 'Name':new_name,'Label':label[i],'Split':split}, ignore_index=True)
...
def biuld_sources_from_metadata(metadata,data_dir,mode='train',exclude_labels=None):
...
if __name__ == '__main__':
    ...
    # Image folder path 
    data_path = '/home/santi/Documents/Dataset_prueba'
